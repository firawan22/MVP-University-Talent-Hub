...
let RecommendationsController = class RecommendationsController {
    ...
    recommendOpportunities(user) {
        return this.svc.recommendOpportunities(user.id);
    }
    recommendSkills(user) {
...
], RecommendationsController.prototype, "recommendOpportunities", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], RecommendationsController.prototype, "recommendSkills", null);
